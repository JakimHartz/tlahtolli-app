...
**Tlahtolli** (del vocablo náhuatl: *palabra*, *lengua* o *discurso*) es un proyecto de aplicación móvil nativa desarrollado en **Flutter** para el sistema operativo Android. Su objetivo principal es la traducción bidireccional entre el idioma **Náhuatl** y el **Español**, incluyendo la transcripción fonética de los términos consultados.

Este proyecto ha sido desarrollado para la evaluación del **Proyecto Ordinario** en la materia de *Programación de Dispositivos Móviles*.

## Características principales

- **Traducción bidireccional:** Soporte completo para flujos Español ↔ Náhuatl.
- **Transcripción Fonética:** Guía de pronunciación basada en caracteres fonéticos del **Alfabeto Fonético Internacional (AFI)**.
